        ...
        <div key={i} className="border border-gray-200 dark:border-neutral-700 rounded-xl p-4 space-y-3 bg-gray-50/60 dark:bg-neutral-800/40">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input type="date" value={p.produkTglKirimQC ? String(p.produkTglKirimQC).slice(0, 10) : ""}
            ...
            <div>
              ...
              <input type="date" value={p.produkTglKeluarHasil ? String(p.produkTglKeluarHasil).slice(0, 10) : ""}
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="col-span-2">
              ...
              <textarea value={p.stabtestKeterangan} rows={2} onChange={e => upd(i, "stabtestKeterangan", e.target.value)}
