...
function SelectHasil({ label, value, onChange, disabled }: {
...
function SelectStatus({ label, value, onChange, disabled }: {
  label: string; value: string; onChange: (v: string) => void; disabled: boolean
}) {
  return (
    <div>
            ...
            <div key={index} className="p-4 bg-gray-50 dark:bg-neutral-800/50 rounded-lg border border-gray-200 dark:border-neutral-700 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="col-span-2">
                  ...
                  <input type="text" value={toStr(product.kodeProduk)}
                ...
                <div>
                  ...
                  <input type="date" value={toStr(product.produkTglKirimQC)}
                ...
                <div>
                  ...
                  <input type="date" value={toStr(product.produkTglKeluarHasil)}
                    onChange={e => update(index, "produkTglKeluarHasil", e.target.value)}
                    disabled={!canEdit} className={inputClass} />
                </div>
                <SelectHasil label="Fisik" value={toStr(product.produkFisik)} onChange={v => update(index, "produkFisik", v)} disabled={!canEdit} />
                <SelectHasil label="Kimia" value={toStr(product.produkKimia)} onChange={v => update(index, "produkKimia", v)} disabled={!canEdit} />
                <SelectHasil label="Mikrobiologi" value={toStr(product.produkMikrobiologi)} onChange={v => update(index, "produkMikrobiologi", v)} disabled={!canEdit} />
                <SelectHasil label="Sensori" value={toStr(product.produkSensori)} onChange={v => update(index, "produkSensori", v)} disabled={!canEdit} />
                <div className="col-span-2">
                  <SelectHasil label="Cek Karakteristik Produk" value={toStr(product.produkCekKarakteristik)} onChange={v => update(index, "produkCekKarakteristik", v)} disabled={!canEdit} />
                </div>
              </div>
              ...
              <div className="pt-3 mt-3 border-t border-gray-200 dark:border-neutral-700">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <SelectHasil label="Fisik" value={toStr(product.stabtestFisik)} onChange={v => update(index, "stabtestFisik", v)} disabled={!canEdit} />
                  <SelectHasil label="Kimia" value={toStr(product.stabtestKimia)} onChange={v => update(index, "stabtestKimia", v)} disabled={!canEdit} />
                  <SelectHasil label="Mikrobiologi" value={toStr(product.stabtestMikrobiologi)} onChange={v => update(index, "stabtestMikrobiologi", v)} disabled={!canEdit} />
                  <SelectHasil label="Sensori DFCT" value={toStr(product.stabtestSensoriDFCT)} onChange={v => update(index, "stabtestSensoriDFCT", v)} disabled={!canEdit} />
                  <SelectStatus label="Status" value={toStr(product.stabtestStatus)} onChange={v => update(index, "stabtestStatus", v)} disabled={!canEdit} />
                  <div className="col-span-2">
                    <label className={labelClass}>Keterangan</label>
                    <textarea value={toStr(product.keterangan)} onChange={e => update(index, "keterangan", e.target.value)}
          ...
          {products.map((product, index) => (
            <div key={index} className="p-4 bg-gray-50 dark:bg-neutral-800/50 rounded-lg border border-gray-200 dark:border-neutral-700 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="col-span-2">
                  <SelectHasil label="Evaluasi as Kemasan" value={toStr(product.evaluasiAsKemasan)} onChange={v => update(index, "evaluasiAsKemasan", v)} disabled={!canEdit} />
                </div>
              ...
              <div className="pt-3 mt-3 border-t border-gray-200 dark:border-neutral-700">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="col-span-2">
                    ...
                    <textarea value={toStr(product.stabtestKeterangan)} onChange={e => update(index, "stabtestKeterangan", e.target.value)}
                      disabled={!canEdit} rows={2}
                      className="w-full px-2.5 py-1.5 text-sm border border-gray-200 dark:border-neutral-700 rounded-lg bg-white dark:bg-neutral-800 text-gray-700 dark:text-gray-200 focus:outline-none focus:border-[#2e3192] transition-colors resize-none disabled:cursor-not-allowed" />
                  </div>
                </div>
